...
val concat1 = concat (concat segment1 fromList3)
...
val map_subscriptError3Or4Mod5_map_inc_concat1 = map subscriptError3Or4Mod5 map_inc_concat1
val _ = (
...
val _ = printDashes()
val _ = print "\nval map_subscriptError4Mod5_map_inc_concat2 = map subscriptError4Mod5 map_inc_concat2"
...
val map_isHalfEven_reallyBigSeq = map (fn n => (n div 2) mod 2 = 0) reallyBigSeq
val _ = (
...
val map_subscriptError3Or4Mod5_map_half_reallyBigSeq = map subscriptError3Or4Mod5 map_half_reallyBigSeq
val _ = (
...
val map_isQuarterEven_reallyBigSeq2 = map (fn n => (n div 2) mod 2 = 0) reallyBigSeq2
val _ = (
...
val map_subscriptError3Or4Mod5_map_quarter_reallyBigSeq2 = map subscriptError3Or4Mod5 map_quarter_reallyBigSeq2
val _ = (
