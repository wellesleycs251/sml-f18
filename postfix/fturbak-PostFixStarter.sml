...
structure PostFix = struct
  ...
  *)
  ...
  and execCmd (Int i) vs = (IntVal i) :: vs
    ...
    | execCmd (Arithop aop) ((IntVal i2) :: (IntVal i1) :: vs) =
      (IntVal ((arithopToFun aop) (i1,i2))) :: vs
    | execCmd (Relop rop) ((IntVal i2) :: (IntVal i1) :: vs) =
      (IntVal (boolToInt ((relopToFun rop) (i1,i2)))) :: vs
    | execCmd Nget ((IntVal index) :: vs) =
      if index < 1 orelse index > (len vs) then
	  raise ExecError "Index out of bounds"
      else
